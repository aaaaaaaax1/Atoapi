...
use admin::{
    ...
    get_metrics, get_metrics_trend, get_proxy_mode_status, get_proxy_status, get_release_champion,
    probe_provider_balance, probe_provider_cache_capabilities, probe_provider_health,
    ...
    set_agent_injection_enabled, set_cache_validation_mode, start_proxy, stop_proxy,
    test_active_provider_key, test_provider_connection_paths, test_provider_key,
